...
//     var query_in_player = new AV.Query('Player');
//     var query_in_team = new AV.Query('Team');
//     var find_or_not = false;

//     query_in_player.equalTo('Name',inputVal);
//     query_in_player.find().then(function(todo){
//         alert(0);
//         find_or_not = true;
//         var url = "playerInfo.html?name="+inputVal;
//         url = encodeURI(url);
...
//     query_in_team.find().then(function(toto){
//         find_or_not = true;
...
//         alert("Sorry, no such a team or player!");
//     }
// }
